...
function rng(delimiter: string = '-', length: number = 2, useToken: boolean = false, capitalize: boolean = false): string {
    ...
    return generated.join(delimiter);
}
